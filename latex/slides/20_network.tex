...
\begin{frame}[fragile = singleslide]{Sockets}
...
\begin{frame}[fragile = singleslide]{\texttt{socket()}}
...
% - close[socket]()
\begin{frame}[fragile = singleslide]{\texttt{close[socket]()}}
...
\begin{frame}[fragile = singleslide]{\texttt{connect()}}
...
\begin{frame}[fragile = singleslide]{\texttt{bind()}}
...
\begin{frame}[fragile = singleslide]{\texttt{listen()}}
...
\begin{frame}[fragile = singleslide]{\texttt{accept()}}
...
% - send()
\begin{frame}[fragile = singleslide]{\texttt{send[to]()}}
...
% recv()
\begin{frame}[fragile = singleslide]{\texttt{recv[from]()}}
