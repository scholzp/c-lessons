...
\subsection{}
\begin{frame}[fragile = singleslide]{Let's calc}
...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile = singleslide]{You see, it's not that easy}
	\begin{itemize}
...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile = singleslide]{Syntactic sugar}
...
\begin{frame}{The truth about expressions}
	...
	\end{itemize}
\end{frame}
\begin{frame}[fragile = singleslide]{Do not get confused}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile = singleslide]{A sign meant...}
...
\begin{frame}[fragile = singleslide]{Seems logical}
...
\section{Conditions}
\subsection{}
\begin{frame}[fragile = singleslide]{if...else}
...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile = singleslide]{else if}
...
\begin{frame}[fragile = singleslide]{switch}
...
\begin{frame}[fragile = singleslide]{Scopes}
...
\begin{frame}[fragile = singleslide]{Shadowing identifiers}
...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile = singleslide]{More words on style}
	\begin{itemize}
