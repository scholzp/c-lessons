...
\section{Pointers}
\subsection{}
\begin{frame}[fragile = singleslide = singlelside]{RGB}
...
\begin{frame}[fragile = singleslide]{Operators}
	\begin{itemize}
...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile = singleslide]{Increment and decrement}
...
\end{frame}
\begin{frame}[fragile = singleslide]{Back to RGB}
...
\end{lstlisting}
	...
	\end{itemize}
\end{frame}
\begin{frame}[fragile = singleslide]{Returning pointers}
...
\subsection{}
\begin{frame}[fragile = singleslide]{p++}
...
\end{lstlisting}
	...
	\end{itemize}
\end{frame}
\begin{frame}[fragile = singleslide]{Pointers and arrays}
...
\subsection{}
\begin{frame}[fragile = singleslide]{\textbf{argc} and \textbf{argv}}
...
\begin{frame}[fragile = singleslide]{Misc.}
