...
\subsection{}
\begin{frame}[fragile = singleslide]{Runtime conditions}
...
\begin{frame}[fragile = singleslide]{A closer look at memory}
...
\end{frame}
\begin{frame}[fragile = singleslide]{\textit{malloc()} in detail}
...
\begin{frame}[fragile = singleslide]{Casting or not casting\dots}
...
\end{frame}
\begin{frame}[fragile = singleslide]{Tidying up}
...
\subsection{}
\begin{frame}[fragile = singleslide]{Reserving large chunks}
...
\begin{frame}[fragile = singleslide]{The fancy alternative}
		\begin{lstlisting}[numbers=none]
...
\begin{frame}[fragile = singleslide]{Resizing arrays}
...
\end{lstlisting}
	...
	\end{itemize}
\end{frame}
\begin{frame}[fragile = singleslide]{Clean up your code}
...
\end{lstlisting}\ \\
	...
	\end{uncoverenv}
\end{frame}
\begin{frame}[fragile = singleslide]{Strings from pointers to \textit{char}}
