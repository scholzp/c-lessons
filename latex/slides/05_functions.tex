...
\begin{frame}[fragile = singleslide]{\only<1>{Remember the main \textit{function}?}%
...
\begin{frame}[fragile = singleslide]{Passing arguments}
	\begin{itemize}
...
\end{frame}
\begin{frame}[fragile = singleslide]{Where not to call functions}
...
\end{frame}
\begin{frame}[fragile = singleslide]{Prototypes}
...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile = singleslide]{Better program structure}
...
\begin{frame}[fragile = singleslide]{Good documentation style}
...
\section{Recursion}
\subsection{}
\begin{frame}[fragile = singleslide]{Recursive functions}
	\begin{itemize}
...
\end{frame}
\begin{frame}[fragile = singleslide]{Exponentiation}
