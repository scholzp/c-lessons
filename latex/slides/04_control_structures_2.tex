...
\section{Loops}
\subsection{}
\begin{frame}[fragile = singleslide]{Loops}
...
\end{frame}
\begin{frame}[fragile = singleslide]{while}
...
\begin{frame}[fragile = singleslide]{do...while}
...
\end{frame}
\begin{frame}[fragile = singleslide]{for}
...
\subsection{}
\begin{frame}[fragile = singleslide]{Meanwhile...}
	Be careful, this
	\begin{lstlisting}[numbers=none]
while (1 > 0)
...
\begin{frame}[fragile = singleslide]{for ever}
...
\begin{frame}[fragile = singleslide]{Saving code lines}
...
\begin{frame}[fragile = singleslide]{Compiler options}
