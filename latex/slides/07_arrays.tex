...
\begin{frame}[fragile = singleslide]{Definition}
...
\end{frame}
\begin{frame}[fragile = singleslide]{Partial initialization}
...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile = singleslide]{Access}
...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile = singleslide]{Looping through arrays}
...
\section{sizeof}
\subsection{}
\begin{frame}[fragile = singleslide]{Remember, Remember}
	Old and busted:
	\begin{itemize}
...
\begin{frame}[fragile = singleslide]{Sizeof an array}
	What if?
	\begin{lstlisting}[numbers=none]
int leet[] = {1, 3, 3, 7};
printf("%d\n",sizeof leet);
...
\subsection{}
\begin{frame}[fragile = singleslide]{Oh, hello again}
...
\begin{frame}[fragile = singleslide]{Printing strings}
...
\begin{frame}[fragile = singleslide]{String input}
...
\end{lstlisting}
	...
	\end{itemize}
\end{frame}
\begin{frame}[fragile = singleslide]{Passing arrays}
...
\end{frame}
%
\begin{frame}[fragile = singleslide]{Arrays of arrays}
	\begin{itemize}
...
\end{frame}
%
\begin{frame}[fragile = singleslide]{Passing arrays of arrays}
	\begin{itemize}
