...
\begin{frame}{Array printing function}
    \href{http://fsr.github.io/c-lessons/exercises/17_array_printing_function.html}{Task as online:} \newline
...
\begin{frame}{To equal or not to equal}
    \href{http://fsr.github.io/c-lessons/exercises/18_to_equal_or_not_to_equal.html}{Task as online:} \newline
    Write a programm that checks two \begin{math}2\times2 \end{math}                                             matrices for equality.
    \newline 
    \newline
    Experts: Extend your programm to check two \begin{math}n\times n\end{math} matrices.
\end{frame}
...
\begin{frame}[fragile]{Matrix multiplication}
    Task:
    \newline
    Write a function that multiplies two matrices A and B with:
    \newline
     
    \begin{center}
    \begin{math}A \in \mathbb{N}^{m\times n} \end{math};  
    \begin{math}B \in \mathbb{N}^{l\times n} \end{math};  
    \begin{math}n,m,l \in \mathbb{N} \end{math}                                          
    \end{center}
