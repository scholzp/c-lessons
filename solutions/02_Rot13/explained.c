...
/*
* Das hier ist eine einfache Lösung für das Program Rot13 vom 07.11.2018 mit Erklärung.
*/
...
int main(void){
	...
	scanf("%c", &letter);
	/*
	* scanf steht für "scan formatted" und bedeutet, dass der
	...
	*/
	...
	letter = letter + 13;
	/*
	* Hier wird unserer Variablen letter ein neuer Wert zugewiesen, der aus dem alten
	* Wert von letter + 13 besteht.
	*/
